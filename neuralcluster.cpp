...
*/
                    ...
                    */
                    ...
                    weightsActive[i][j] += (actJ*actI*(1.0-actI)*(signum((((samplerRealOutputSignal[j]*weightsActive[i][j])/(1.0+samplerRealOutput[j]))-(samplerRealInputSignal[i]/(1.0+samplerRealInput[i]))))))*learningRate;
